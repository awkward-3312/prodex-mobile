...
export function SaleConfirmation({ attempt, error, onNewSale, onSales }: { attempt: SaleAttempt; error?: string; onNewSale: () => void; onSales: () => void }) {
  ...
  return <SafeAreaView style={styles.safe} edges={['top', 'bottom']}><ScrollView contentContainerStyle={styles.content}>
    ...
    <Text style={styles.subtitle}>La venta quedó confirmada en PRODEX.</Text>
