  ...
  return (
    <SafeAreaView style={styles.safe} edges={['top']}>
      ...
      <Modal visible={creatingCustomer} animationType="slide" onRequestClose={() => setCreatingCustomer(false)}>
        <SafeAreaView style={styles.safe}>{creatingCustomer ? <CustomerEditor origin="pos" onCancel={() => setCreatingCustomer(false)} onSuccess={client => {
          setSelectedCustomer({ id: client.id, name: client.name, phone: client.phone || null, rtn: client.tax_number || null });
...
const styles = StyleSheet.create({
  ...
  paymentBox: { ...surfaces.card, marginTop: spacing.md, padding: spacing.lg },
