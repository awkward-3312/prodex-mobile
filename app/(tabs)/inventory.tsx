...
const styles = StyleSheet.create({
  ...
  summaryCard: { ...surfaces.card, flexDirection: 'row', marginTop: spacing.md, paddingVertical: spacing.xl },
  ...
  summaryValue: { color: colors.brandDark, fontSize: 28, fontWeight: fontWeights.heavy },
